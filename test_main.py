...
@pytest.mark.parametrize("item,variation,expected", [
...
@pytest.mark.parametrize("item,variation,pattern,expected", [
    # Iron Worktable 0x0DE8, 2 variations, 0 patterns
    ("0DE8", 0, 0, "0DE8"),

    ("0DE8", 1, 0, "0000000100000DE8"),

    # Iron Hanger Stand 0x0DE9, 2 variations, 2 patterns
    ("0DE9", 0, 0, "0DE9"),
